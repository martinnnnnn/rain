...
namespace rain::core
{
    ...
    void quick_hull(glm::vec3 const *  vertices, const u32 vertices_count, mesh* output)
    {
        qh_vertex_t * lib_vertices = (qh_vertex_t *)vertices;
        qh_mesh_t lib_mesh = qh_quickhull3d(lib_vertices, vertices_count);

        output->vertices = (glm::vec3*)malloc(lib_mesh.nvertices * sizeof(glm::vec3));
        output->vertices = (glm::vec3*)lib_mesh.vertices;
        ...
        output->normals = (glm::vec3*)lib_mesh.normals;

...
namespace rain::core
{
    ...
    */
     ...
     */
    float simplex_noise::noise(float x) 
    {
     ...
     * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
     */
    float simplex_noise::noise(float x, float y) 
    {
     ...
     * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
     */
    float simplex_noise::noise(float x, float y, float z)
    {
     ...
     * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
     */
    float simplex_noise::fractal(size_t octaves, float x) const
    {
        float output = 0.f;
        float denom = 0.f;
     ...
     * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
     */
    float simplex_noise::fractal(size_t octaves, float x, float y) const 
    {
        float output = 0.f;
        float denom = 0.f;
        float frequency = mFrequency;
     ...
     * @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
     */
    float simplex_noise::fractal(size_t octaves, float x, float y, float z) const
    {
        float output = 0.f;
        float denom = 0.f;
        float frequency = mFrequency;
